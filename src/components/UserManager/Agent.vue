...
<section>
    ...
    <!--列表-->
    <template>
        <el-table :data="agents" highlight-current-row v-loading="listLoading" border style="width: 100%;top: 0px;
    ...
    <el-dialog :title="infoFormTtile" v-model="infoFormVisible" :close-on-click-modal="false">
        ...
        <!-- <div slot="footer" class="dialog-footer">
            <el-button @click.native="infoFormVisible = false">拒 绝</el-button>
...
export default {
    ...
    created() {
        ...
        this.$store.dispatch('agentList', params)
    },
